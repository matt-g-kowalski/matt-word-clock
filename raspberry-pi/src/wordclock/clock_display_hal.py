...
class ClockDisplayHAL:
    ...
    def __init__(self, board_pin, max_brightness):
        self.pixels = neopixel.NeoPixel(getattr(board, board_pin), self.NUM_LEDS, brightness=max_brightness, auto_write=False)
